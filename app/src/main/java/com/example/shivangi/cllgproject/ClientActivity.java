...
package com.example.shivangi.cllgproject;
    ...
    public void searchForPeers(View view) {
        ...
        wifiManager.discoverPeers(wifichannel, new WifiP2pManager.ActionListener() {
			...
			public void onSuccess() {
				Toast.makeText(ClientActivity.this, "peers avalaible", Toast.LENGTH_SHORT).show();
			}

			@Override
			public void onFailure(int i) {
				Toast.makeText(ClientActivity.this, "no peers available", Toast.LENGTH_SHORT).show();
			}
		});
